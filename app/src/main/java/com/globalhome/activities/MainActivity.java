...
import com.globalhome.data.PackageName;
import com.globalhome.data.PreInstallApkPath;
...
import com.globalhome.data.json.regoem.RecommendvideoBean;
import com.globalhome.data.json.regoem.RemoveAppBean;
import com.globalhome.services.MyService;
import com.globalhome.services.SerialService;
...
//                        binding.fl16.requestFocus();
        ...
        filter.addAction("com.globalhome.services");
...
/*                    runOnUiThread(new Runnable() {
    ...
    private void startVedioPlayerActivity() {
        ...
        ComponentName cn = new ComponentName("com.h3launcher", "com.globalhome.activities.VideoActivity");
    ...
    public class MyReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ((_action.contains("首页")) || (_action.contains("桌面")) || (_action.contains("主页"))) {
                ...
                //ComponentName cn = new ComponentName("com.h3launcher", "com.globalhome.activities.MainActivity");
                //i.setComponent(cn);
                //startActivity(i);
