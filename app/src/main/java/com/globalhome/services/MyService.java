...
import com.globalhome.utils.ProperityUtils;
...
//                        }
                ...
                if (b == false) {
                    ...
                    if (isTopActivity("com.tencent.karaoketv") && (!info.contains("电影"))) {
                        ...
                        pauseMusic();
                        return;
                    } else if (isTopActivity("com.h3launcher")) {
                    }
    ...
    private boolean doAppAction(Intent intent) {
        ...
        if (action_Cammand.equals("JHZSIGNAL0003")) {
            ...
            d.setAction("com.globalhome.services");
            sendBroadcast(d);
            returnVoiceFeedback(action_music);
            return true;
    ...
    Handler mMyHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1) {
                ...
                //intent.setAction("com.globalhome.services");
